...
const bookingFormSchema = z.object({
  ...
  serviceFeePercentage: z.string().refine((val) => !isNaN(Number(val)) && Number(val) >= 0 && Number(val) <= 100, {
    message: "Service fee percentage must be a number between 0 and 100.",
  }),
  minBookingDays: z.string().refine((val) => !isNaN(Number(val)) && Number(val) > 0, {
    message: "Minimum booking days must be a positive number.",
  }),
  maxBookingDays: z.string().refine((val) => !isNaN(Number(val)) && Number(val) > 0, {
...
const securityFormSchema = z.object({
  ...
  loginAttempts: z.string().refine((val) => !isNaN(Number(val)) && Number(val) > 0, {
    message: "Login attempts must be a positive number.",
  }),
  sessionTimeout: z.string().refine((val) => !isNaN(Number(val)) && Number(val) > 0, {
...
export default function AdminSettingsPage() {
  ...
  const platformForm = useForm<PlatformFormValues>({
    ...
    defaultValues: {
      siteName: "StayScape",
      siteDescription: "Find and book your perfect stay from our collection of properties.",
      contactEmail: "admin@stayscape.com",
        ...
        <TabsContent value="platform">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure general platform settings and information.</CardDescription>
            </CardHeader>
            <Form {...platformForm}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormDescription>
                          This is the name of your platform that will be displayed to users.
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Public contact email for your platform.</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
        ...
        <TabsContent value="booking">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure settings related to bookings and reservations.</CardDescription>
            </CardHeader>
            <Form {...bookingForm}>
                ...
                <CardContent className="space-y-6">
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Percentage commission charged to hosts for each booking.</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Percentage service fee charged to guests for each booking.</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Minimum number of days for a booking.</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>Maximum number of days for a booking.</FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
                    />
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          ...
                          <FormDescription>Allow guests to book instantly without host approval.</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base">Require User Verification</FormLabel>
                          <FormDescription>Require users to verify their identity before booking.</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
                ...
                <CardContent className="space-y-6">
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                        <div className="space-y-0.5">
                          <FormLabel className="text-base">User Verification</FormLabel>
                          <FormDescription>Require email verification for new user registrations.</FormDescription>
                        </div>
                        <FormControl>
                          <Switch checked={field.value} onCheckedChange={field.onChange} />
                        </FormControl>
                  ...
                  <div className="rounded-lg border p-4">
                    <h3 className="text-base font-medium">Data Retention Policy</h3>
                    <p className="mt-1 text-sm text-muted-foreground">
                      Configure how long user data is retained after account deletion.
                    </p>
                  ...
                  <div className="rounded-lg border p-4">
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                      Manage API access and generate API keys for third-party integrations.
                    </p>
