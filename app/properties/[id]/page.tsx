              ...
              <div className="mb-8 flex items-center justify-between border-b pb-6">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    {property.bedrooms} bedrooms • {property.bathrooms} bathrooms • {property.maxGuests} guests max
                  </p>
                </div>
              ...
              <Tabs defaultValue="reviews" className="mb-8">
                ...
                <TabsContent value="reviews">
                  ...
                  <div className="space-y-6">
                        ...
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-muted-foreground">
                              {new Date(2025, i, i + 10).toLocaleDateString("en-US", {
                                year: "numeric",
                                month: "long",
                              })}
                            </div>
                    ...
                    <Button variant="outline">Show all {property.reviews} reviews</Button>
                  </div>
                </TabsContent>
                ...
                <TabsContent value="host">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-medium">{property.host.name}</h3>
                      <p className="text-muted-foreground">Host since {property.host.joined}</p>
            ...
            <div>
              <Card className="sticky top-24">
                ...
                <CardContent className="space-y-4">
                  <div className="rounded-lg border">
                    <div className="flex">
                      <div className="flex-1 border-r p-4">
                        <div className="text-xs font-medium uppercase">Check-in</div>
                      ...
                      <div className="flex-1 p-4">
                        <div className="text-xs font-medium uppercase">Checkout</div>
                        <div className="font-medium">
                    ...
                    <div className="border-t p-4">
                      <div className="text-xs font-medium uppercase">Guests</div>
                  ...
                  <Button className="w-full" size="lg" disabled={!selectedDates || selectedDates.length < 2}>
                    Reserve
                  </Button>
                    ...
                    <div className="space-y-2 pt-4">
                      <div className="flex justify-between">
                        <span>
                          ${property.price} x{" "}
                          {Math.ceil(
                            (selectedDates[selectedDates.length - 1].getTime() - selectedDates[0].getTime()) /
                              (1000 * 60 * 60 * 24),
                          )}{" "}
                          nights
                        </span>
                ...
                <CardFooter>
                  <p className="text-center text-xs text-muted-foreground">
                    You won't be charged yet. Cancellation policy: {property.cancellationPolicy}
                  </p>
                </CardFooter>
              </Card>
            </div>
